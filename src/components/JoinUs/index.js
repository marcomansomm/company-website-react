...
import styles from './JoinUs.module.css'; // Importa o CSS Module
import FormField from '../FormField';

const JoinUs = () => {
  return (
    <div className={styles.formSignin}>
      <div className={`text-center mb-4 ${styles.fontColor} mt-4`}>
      ...
      <form>
        <div className="form-row" style={{ display: 'flex' }}>
          <FormField
            ...
            required={true}
            autoFocus={true}
            groupClass={`form-group col-md-6 ${styles.fontColor}`}
          />
          <FormField
            type="text"
            id="inputName"
        ...
        <div className={`alert alert-warning ${styles.alertWarning}`} id="passwordWarning">
        ...
        <div className={`form-row ${styles.fontColor}`} style={{ display: 'flex' }}>
          <FormField
            type="tel"
            id="inputPhone"
            className={`form-control ${styles.inputcolor}`}
          ...
          <FormField
            ...
            label="Date of Birth"
            groupClass={`form-group col-md-3 ${styles.fontColor}`}
          />
          <FormField
            type="text"
            id="inputCpf"
            ...
            placeholder=""
            label="CPF"
            groupClass={`form-group col-md-4 ${styles.fontColor}`}
          />
        </div>
        <div className={`form-row ${styles.fontColor}`} style={{ display: 'flex' }}>
          <div className="form-group col-md-4">
            <label htmlFor="inputEducation">Education level</label>
            <select id="inputEducation" className={`form-control ${styles.inputcolor}`} defaultValue="3">
        ...
        <p className={`text-center mt-4 ${styles.fontColor}`}> Already have an account? <a href="logIn.html">Log In</a></p>
